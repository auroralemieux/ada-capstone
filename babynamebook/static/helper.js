    ...
    function favoriteHandler(event) {
      if (event.handled !== true) {
        var toggleHeart = function() {
          ...
          if ($(whichHeart).attr('src') == "https://babynamebooktestbucket.s3.amazonaws.com/static/blue-heart-icon.png") {
            $(whichHeart).attr("src", "https://babynamebooktestbucket.s3.amazonaws.com/static/plain-heart.jpg");
          } else {
            $(whichHeart).attr("src", "https://babynamebooktestbucket.s3.amazonaws.com/static/blue-heart-icon.png");
          }
        };
        toggleHeart();
